A Hotel Booking Admin Dashboard backend created using Express.js, validation with joi, authentication using OAuth 2.0 and Passport.js and express-session, File upload using multer. Added SMS service using twilio
